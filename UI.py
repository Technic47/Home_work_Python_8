...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.select_table.setGeometry(QtCore.QRect(10, 10, 71, 23))
        self.select_table.setObjectName("select_table")
        self.table_list = QtWidgets.QComboBox(self.groupBox)
        self.table_list.setGeometry(QtCore.QRect(81, 11, 139, 21))
        ...
        self.merge_method.setGeometry(QtCore.QRect(0, 100, 80, 21))
        ...
        self.merge_method.addItem("")
        self.merge_method.addItem("")
        self.table_list_2 = QtWidgets.QComboBox(self.tab)
        self.table_list_2.setGeometry(QtCore.QRect(0, 10, 80, 21))
        self.table_list_2.setEditable(False)
        self.table_list_2.setObjectName("table_list_2")
        self.label_3 = QtWidgets.QLabel(self.tab)
        self.label_3.setGeometry(QtCore.QRect(140, 100, 71, 23))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.tab)
        self.label_4.setGeometry(QtCore.QRect(130, 10, 91, 23))
        self.label_4.setObjectName("label_4")
        self.current_cols = QtWidgets.QLineEdit(self.tab)
        self.current_cols.setGeometry(QtCore.QRect(0, 130, 80, 23))
        self.current_cols.setObjectName("current_cols")
        self.second_cols = QtWidgets.QLineEdit(self.tab)
        self.second_cols.setGeometry(QtCore.QRect(0, 160, 80, 23))
        self.second_cols.setObjectName("second_cols")
        self.label_5 = QtWidgets.QLabel(self.tab)
        self.label_5.setGeometry(QtCore.QRect(130, 40, 91, 23))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.tab)
        self.label_6.setGeometry(QtCore.QRect(130, 70, 91, 23))
        self.label_6.setObjectName("label_6")
        self.current_cols_list = QtWidgets.QComboBox(self.tab)
        self.current_cols_list.setGeometry(QtCore.QRect(0, 40, 80, 21))
        self.current_cols_list.setEditable(False)
        self.current_cols_list.setObjectName("current_cols_list")
        self.second_cols_list = QtWidgets.QComboBox(self.tab)
        self.second_cols_list.setGeometry(QtCore.QRect(0, 70, 80, 21))
        self.second_cols_list.setEditable(False)
        self.second_cols_list.setObjectName("second_cols_list")
        self.btn_cols_info = QtWidgets.QPushButton(self.tab)
        self.btn_cols_info.setGeometry(QtCore.QRect(0, 200, 71, 23))
        self.btn_cols_info.setObjectName("btn_cols_info")
        self.btn_add_current_col = QtWidgets.QPushButton(self.tab)
        self.btn_add_current_col.setGeometry(QtCore.QRect(90, 39, 31, 23))
        self.btn_add_current_col.setObjectName("btn_add_current_col")
        self.btn_add_second_col = QtWidgets.QPushButton(self.tab)
        self.btn_add_second_col.setGeometry(QtCore.QRect(90, 69, 31, 23))
        self.btn_add_second_col.setObjectName("btn_add_second_col")
        self.btn_add_second_col_2 = QtWidgets.QPushButton(self.tab)
        self.btn_add_second_col_2.setGeometry(QtCore.QRect(90, 159, 31, 23))
        self.btn_add_second_col_2.setObjectName("btn_add_second_col_2")
        self.btn_add_current_col_2 = QtWidgets.QPushButton(self.tab)
        self.btn_add_current_col_2.setGeometry(QtCore.QRect(90, 129, 31, 23))
        self.btn_add_current_col_2.setObjectName("btn_add_current_col_2")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.select_table.setText(_translate("Dialog", "Select Table"))
        ...
        self.btn_cols_info.setText(_translate("Dialog", "Get cols info"))
        self.btn_add_current_col.setText(_translate("Dialog", "Add"))
        self.btn_add_second_col.setText(_translate("Dialog", "Add"))
        self.btn_add_second_col_2.setText(_translate("Dialog", "Add"))
        self.btn_add_current_col_2.setText(_translate("Dialog", "Add"))
